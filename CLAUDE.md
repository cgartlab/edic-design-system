...
**EDIC Design System** (formerly CGArtLab) — Editorial × Olive Green, a zero-runtime-dependency static design system driven by OKLch color science and design tokens. Current version: **v1.6.0**.
...
# 4. Commit
git add -A && git commit -m "chore(release): bump to v1.6.0"
