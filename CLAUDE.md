...
**EDIC Design System** (formerly CGArtLab) — Editorial × Olive Green, a zero-runtime-dependency static design system driven by OKLch color science and design tokens. Current version: **v2.8.0**.
...
| File | Role |
|------|------|
| `styles.css` | All design tokens (`:root` + `[data-theme="dark"]`), 44 component families, animations, site shell |
